...
.controller('engageAppCtrl',
  ...
  function($scope, $rootScope, growl,FileUploader) {
    ...
    $scope.statementBankingData = [
      ...
      {"name":"Loyalty Id"},
      {"name":"Loyalty Email"},
      {"name":"Loyalty Phone Number"},
      {"name":"Loyalty First Name"},
      {"name":"Loyalty Last Name"},
      {"name":"Birthday"},
      {"name":"Signedup Date"},
      {"name":"Last Purchase"},
      {"name":"Last Visit"},
    ...
    $scope.groups = [
       {
      title: 'Frequent Short Distance Flyers',
      open: true,
      content: 'Those who fly within a distance of 3 hours flight'
      },
      {
        title: 'One way ticket bookers',
        open: false,
        content: 'Always book one way tickets'
      },
      {
        title: 'Last booked 3 months back',
        open: false,
        content: 'Havent visited the site or booked ticket in last 3 months'
      },
      {
        title: 'Not App user yet',
        open: false,
        content: 'Registered user but hasnt downloaded and used the App'
      },
      {
        title: 'Loyal Customers',
        open: false,
        content: 'Frequently book and are part of loyalty program'
      }
    ];
    ...
    $scope.savedSegments = [
      ...
      {
        name: "Registered Before Jan 01, 2014",
        desc: "",
        reach: "710181"
      },
      {
